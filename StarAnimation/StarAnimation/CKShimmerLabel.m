...
#pragma mark - 修改闪动的宽度和半径
    self.shimmerWidth = 10;
    self.shimmerRadius = 10;
...
#pragma mark - 改变闪光的角度在这两行代码中
//         这种是-45度
//        _maskLayer.startPoint = CGPointMake(0, 1);
//        _maskLayer.endPoint = CGPointMake(1, 0.7);
...
//         这种是45度
        _maskLayer.startPoint = CGPointMake(0, 0.7);
